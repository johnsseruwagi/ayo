defmodule AyoWeb.Components.Menu do
  @moduledoc """
  The `AyoWeb.Components.Menu` module is designed to render a hierarchical menu structure in
  ...
  The `AyoWeb.Components.Menu` is ideal for creating multi-level navigation menus in
  ...
  import AyoWeb.Components.Accordion, only: [accordion: 1]
  import AyoWeb.Components.Button, only: [button_link: 1]
