defmodule AyoWeb.Components.CheckboxField do
  @moduledoc """
  AyoWeb.Components.CheckboxField Module Provides a customizable checkbox component for use in Phoenix LiveView forms.
