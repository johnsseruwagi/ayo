defmodule AyoWeb.Components.Tabs do
  @moduledoc """
  `AyoWeb.Components.Tabs` is a Phoenix component module that provides a highly customizable tab
  ...
  import AyoWeb.Components.Badge, only: [badge: 1]
