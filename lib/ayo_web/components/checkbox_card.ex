defmodule AyoWeb.Components.CheckboxCard do
  @moduledoc """
  The `AyoWeb.Components.CheckboxCard` module provides a customizable checkbox card component for Phoenix LiveView
