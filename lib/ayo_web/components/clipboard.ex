defmodule AyoWeb.Components.Clipboard do
  @moduledoc """
  The `AyoWeb.Components.Clipboard` is a Phoenix LiveView component module for creating customizable clipboard functionality.
