defmodule AyoWeb.Components.FileField do
  @moduledoc """
  The `AyoWeb.Components.FileField` module provides a versatile and customizable component
  ...
  defp translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AyoWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AyoWeb.Gettext, "errors", msg, opts)
    end
  end
end
