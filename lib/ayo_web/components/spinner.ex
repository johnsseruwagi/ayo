defmodule AyoWeb.Components.Spinner do
  @moduledoc """
  The `AyoWeb.Components.Spinner` module provides a dynamic and customizable loading spinner
  ...
  With its flexible design, the `AyoWeb.Components.Spinner` module enables developers to provide
