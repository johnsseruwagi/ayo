defmodule AyoWeb.Components.Divider do
  @moduledoc """
  The `AyoWeb.Components.Divider` module provides a versatile and customizable divider
  ...
  @doc """
  `AyoWeb.Components.Divider.hr` is used to create a horizontal divider with customizable style, color,
  and size options.
