...
config :ayo, AyoWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: AyoWeb.ErrorHTML, json: AyoWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Ayo.PubSub,
  live_view: [signing_salt: "MqSozSyz"]
...
config :ayo, Ayo.Mailer, adapter: Swoosh.Adapters.Local
